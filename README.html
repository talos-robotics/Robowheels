...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="gr">
<head>
...
<h1 style="text-align: center;"><img style="width: 550px; height: 550px;" alt="" src="images/logo.png" /><br /></h1>

<div style="background-color:#90EE90;">
<h1 style="text-align: center;">(The Robowheels project)</h1>
<h1 style="text-align: center;">Αυτοματοποιημένο αναπηρικό αμαξίδιο</h1>
</div>

<div style="text-align: left; ">
<h1 style="background-color:powderblue;" align="center"><u> Συμμετέχοντες</u></h1>
<h3 style="background-color:orange; text-align: left;">Υπεύθυνος εκπαιδευτικός</h3>
Μανούσακας Μανούσος - Εκπαιδευτικός Πληροφορικής ΠΕ86
<h3 style="background-color:orange; text-align: left;">Μαθητές</h3>
<ul>
  <li>Αναστασάκης Ιωάννης</li>
  <li>Ρουσιάκης Πέτρος</li>
  <li>Στραβοπόδη Κωνσταντίνα</li>
 </ul>
</br>
</div>

<div>
<h1 style="background-color:powderblue;" align="center"><u> Γενικά στοιχεία σεναρίου</u></h1>
<h3 style="background-color:orange;"><big>Σενάριο δραστηριότητας</big>
...
<h3 style="background-color:orange;"><big>Φάση προετοιμασίας</big></h3>
...
<h3 style="background-color:orange;"><big>Φάση σχεδιασμού</big></h3>Οι μαθητές θα πρέπει να: <br />    
...
<br />
<h3 style="background-color:orange;"><big>Φάση υλοποίησης</big></h3>Οι μαθητές θα πρέπει να:<br />    
...
<h3 style="background-color:orange;"><big>Φάση Δοκιμών</big></h3>
Οι μαθητές θα πρέπει να:<br />    
• Δοκιμάσουν τον εξοπλισμό τους και να επιβεβαιώσουν τη σωστή λειτουργία του.<br /><br /><br />
<h3 style="background-color:orange;"><big>Υλικά</big></h3><table style="width: 100%;" border="1">
...
<h3 style="background-color:orange;"><big>Χρήσιμα αρχεία</big></h3><table style="width: 100%;" border="1">
...
<h3 style="background-color:orange;"><big>Υλικά για την κατασκευή</big></h3><table style="width: 100%;" border="1">
 ...
 <h3 style="background-color:orange; text-align: left;">Προοπτική κατασκευής</h3>
...
<h3 style="background-color:orange;"><big>Αναλυτική περιγραφή</big></h3>
<pre>
...
<div>
<h1 style="background-color:powderblue; text-align: center;"><u> Πλατφόρμες που χρησιμοποιήθηκαν </u></h1>
<br />Όλα τα διαδικτυακά εργαλεία που χρησιμοποιήσαμε ανήκουν στο Πανελλήνιο σχολικό δίκτυο.<br />
...
<h1 style="background-color:powderblue; text-align: center;"><u> Εργαλεία ΕΛΛΑΚ που χρησιμοποιήθηκαν </u></h1>

<ul>
  <li>Libreoffice</li>
  <li>Linux - Elementary OS</li>
  <li>Arduino IDE</li>
  <li>Fritzing</li>
</ul>
...
<br />
<div>
<h1 style="background-color:powderblue; text-align: center;"><u> Πληροφορίες για το υλικό </u></h1>

<h3 style="background-color:orange; text-align: left;">Αισθητήρας GP2Y0A21 IRDA</h3>
...
<h3 style="background-color:orange; text-align: left;">Αισθητήρας Adafruit Επιταχυνσιόμετρο 3 Αξόνων ±2/4/8g @ 14-bit - MMA8451</h3>
...
<b> Αρχή λειτουργίας επιταχυνσιόμετρου.</b>
...
<h3 style="background-color:orange; text-align: left;">Βηματικός Κινητήρας 30kg.cm (200 steps/rev) 57BYGH115</h3>
<img style="width: 200px; height: 200px;" alt="" src="https://grobotronics.com/images/detailed/101/data-wantmotor-57bygh115-003-1-600x600_grobo.jpg" /><br />
...
<b>Σε τι είναι καλοί οι βηματικοί κινητήρες:</b>

<ul>
	<li>Θέση (Positioning) - Δεδομένου ότι κινούνται σε ακριβή επαναλαμβανόμενα βήματα, υπερέχουν σε εφαρμογές που απαιτούν ακριβή κίνηση,	όπως 3D εκτυπωτές, CNC, πλατφόρμες κάμερας και X, Y Plotters.</li>
   <li>Έλεγχος ταχύτητας (Speed Control) - Τα ακριβή βήματα της κίνησης επιτρέπουν επίσης εξαιρετικό έλεγχο της ταχύτητας περιστροφής για την αυτοματοποίηση της διαδικασίας και τη ρομποτική.</li>
   <li>Ροπή χαμηλής ταχύτητας (Low Speed Torque) - Οι κανονικοί κινητήρες DC δεν έχουν μεγάλη ροπή σε χαμηλές ταχύτητες. Ένας βηματικός κινητήρας έχει μέγιστη ροπή σε χαμηλές ταχύτητες, έτσι είναι μια καλή επιλογή για εφαρμογές που απαιτούν χαμηλή ταχύτητα με μεγάλη ακρίβεια.</li>
</ul>
<b>Ποιοι είναι οι περιορισμοί τους:</b>

  <ul> 
   <li>Χαμηλή απόδοση (Low Efficiency) - Σε αντίθεση με τους κινητήρες DC, η κατανάλωση ρεύματος του βηματικού κινητήρα είναι ανεξάρτητη από το φορτίο.</li>
	<li>Τραβάνε ρεύμα ακόμα και όταν δεν δουλεύουν καθόλου. Εξαιτίας αυτού, έχουν την τάση να ζεσταίνονται.</li>
   <li>Περιορισμένη ροπή υψηλής ταχύτητας (Limited High Speed Torque) - Σε γενικές γραμμές, οι βηματικοί κινητήρες έχουν μικρότερη ροπή σε υψηλές ταχύτητες σε σχέση με τις χαμηλές ταχύτητες.</li>
	<li>Ορισμένοι βηματικοί κινητήρες είναι βελτιστοποιημένοι για καλύτερη απόδοση υψηλής ταχύτητας,αλλά πρέπει να συνδυαστούν με έναν κατάλληλο οδηγό (driver) για την επίτευξη αυτής της απόδοσης.</li>
   <li>Χωρίς ανάδραση (No Feedback) - Σε αντίθεση με τα servo, τα περισσότερα βηματικά μοτέρ δεν έχουν ολοκληρωμένη ανατροφοδότηση για τη θέση.</li>
	<li>Αν και μεγάλη ακρίβεια μπορεί να επιτευχθεί με λειτουργία «ανοικτού βρόχου».</li>
	<li>Οι περιοριστικοί διακόπτες (limit switches) ή οι «home detectors» τυπικά απαιτούνται για την ασφάλεια και/ή για τη δημιουργία μιας θέσης αναφοράς.</li>
	</ul>
	
<strong>Όπως διαπιστώνουμε απο τα παραπάνω, ένας κινητήρας DC και όχι βηματικός θα έκανε πολύ καλύτερα το έργο για το οποίο προορίζεται.
Η επιλογή του βηματικού κινητήρα έγινε με γνώμονα τη χρήση του και σε επιμέρους project.</strong>
	</pre>
...
<h3 style="background-color:orange; text-align: left;">Stepper Motor Driver TB6600</h3>
<img style="width: 200px; height: 200px;" alt="" src="https://grobotronics.com/images/thumbnails/350/350/detailed/106/sku_418451_1_grobo.jpg" /><br />
...
<h3 style="background-color:orange; text-align: left;">Μετατροπέας DC-DC Step-Down 1.3-35V 3A</h3>
<img style="width: 200px; height: 200px;" alt="" src="https://grobotronics.com/images/thumbnails/350/350/detailed/100/2596s_low_ripple_grobo.jpg" /><br />
...
<h3 style="background-color:orange; text-align: left;">Αισθητήρας Αναγνώρισης Φωνής</h3>
<img style="width: 200px; height: 200px;" alt="" src="https://grobotronics.com/images/thumbnails/350/350/detailed/106/speak-recognition-voice-recognition-module-v3_grobo.jpg" /><br />
...
<h3 style="background-color:orange; text-align: left;">Waveshare GSM/GPRS/GPS Shield SIM808</h3>
<img style="width: 200px; height: 200px;" alt="" src="https://grobotronics.com/images/thumbnails/350/350/detailed/103/gsm-gprs-gps-shield-b-7_3_grobo.jpg" /><br />
...
<h1 style="background-color:powderblue;">Συνδεσμολογία Υλικού</h1>
<h3 style="background-color:orange; text-align: left;">Περίπτωση 1  - Με τη χρήση ΜΜΑ8451</h3>
<div style="text-align: left; font-size: 12pt; background-color:yellow">
<pre>
<b><u>ΠΕΡΙΓΡΑΦΗ ΛΕΙΤΟΥΡΓΙΑΣ</u></b>

</pre>
</div>

<img style="width: 1000px; height: 700px;" alt="" src="images/robowheels.png" /><br />
<h4 style="background-color:yellow; text-align: left;">Δείτε τον κώδικα</h4>
<div style="text-align: left; font-size: 12pt; background-color:Gainsboro">
...
<div style="text-align: center; text-decoration:">
<h3 style="background-color:orange; text-align: left;">Περίπτωση 2  - Με τη χρήση Αναγνώρισης φωνής</h3>
...
<h4 style="background-color:yellow; text-align: left;">Συνδεσμολογία</h4>
<img style="width: 1000px; height: 700px;" alt="" src="images/robowheelsv2.png" /><br />

<h4 style="background-color:yellow; text-align: left;">Εκπαιδεύστε το module σας</h4>
...
<div>
<h1 style="background-color:powderblue;"><u><center> Στάδια εξέληξης </center></u></h1>
...
<div>
<h1 style="background-color:powderblue;"><u><center>Τελικά συμπερασματα </center></u></h1>
<h3 style="background-color:orange; text-align: left;">Γενικά</h3>
<h3 style="background-color:orange; text-align: left;">Αδυναμίες και βελτιώσεις</h3>
 <br />
<div>
